                                ...
                                @if (request('folder') && isset($currentFolder))
                                    <div class="folder-breadcrumb">
                                        ...
                                        <span class="breadcrumb-item ms-auto">
                                            <a href="{{ route('umkm.index', array_filter(['role' => request('role')])) }}" class="btn btn-sm btn-secondary-custom btn-filter-reset">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-check">
                            <input type="checkbox" name="remove_from_folder" value="1" class="form-check-input"
                                id="removeFromFolder">
                            <label class="form-check-label text-secondary-13" for="removeFromFolder">
